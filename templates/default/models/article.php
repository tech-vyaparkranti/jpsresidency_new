...
if($pms_article_id > 0){
    ...
    $title_tag = isset($title_tag) ? $article['title'] . ' - ' . $title_tag : $article['title'];
            ...
            <div class="row">
                <div class="col-sm-6 mb10">
                    ...
                    <div class="mb10 labels" dir="ltr">
                        <span class="label label-default"><i class="fas fa-fw fa-thumbtack"></i> <?php echo (!PMS_RTL_DIR)
    ? date(str_replace('%', '', PMS_DATE_FORMAT), $article['add_date'])
    : date('Y-m-d', $article['add_date']); ?></span>
