...
echo '<div class="thim-slider-posts ' . $style . '">';
    if ( $instance['title'] ) {
        echo '<div class = "container title-'. $instance['position_title'] .'">';
        echo ent2ncr( $args['before_title'] . $instance['title'] . $args['after_title'] );
        echo '</div>';
    }
    echo '<div class="slider-post-swapper "><div class="slider-post">';
                ...
                <div class="item">
                    <?php
                        if ( has_post_thumbnail() ) {
                            ...
                            the_post_thumbnail( array(700,490) );
                            echo '</a>';
                            echo '</div>';
                        }
                    ?>
