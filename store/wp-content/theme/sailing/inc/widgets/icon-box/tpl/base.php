...
$icon_style .= ( $instance['width_icon_box'] != '' ) ? 'width: ' . $instance['width_icon_box'] . 'px;' : '';
if ( $icon_style ) {
...
if ( $instance['title_group']['line_after_title'] == '1' || $instance['title_group']['line_after_title'] == 'yes') {
...
$prefix .= '<div ' . $background_video . ' class="wrapper-box-icon' . $extent_class . $class_bg_video . ' ' . $instance['layout_group']['text_align_sc'] . '  ' . $instance['layout_group']['box_icon_style'] . $thim_animation . '" ' . $data_color . '>';
$suffix = '</div>';
//wrapper-box-icon
...
if ( $instance['read_more_group']['link'] != '' ) {
	if ( $instance['read_more_group']['read_more'] == 'complete_box' ) {
		$complete_prefix .= '<a class="icon-box-link" href="' . esc_url($instance['read_more_group']['link']) . '">';
		$complete_suffix .= '</a>';
	} elseif ( $instance['read_more_group']['read_more'] == 'more' ) {
		// Display Read More
		$more_link = '<a class="smicon-read sc-btn" href="' . esc_url($instance['read_more_group']['link']) . '" ' . $read_more_style . ' >';
...
<style>
	.smicon-read:hover{
		color:<?php echo $instance['read_more_group']['button_read_more_group']['read_more_text_color_hover'] ?> !important;
		background:<?php echo $instance['read_more_group']['button_read_more_group']['bg_read_more_text_hover'] ?> !important;
	}
	.smicon-box .boxes-icon:hover{
		color:<?php echo $instance['color_group']['icon_hover_color'] ?> !important;
		border-color:<?php echo $instance['color_group']['icon_border_color_hover'] ?> !important;
		background-color: <?php echo $instance['color_group']['icon_bg_color_hover'] ?> !important;
	}
