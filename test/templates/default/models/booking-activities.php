    ...
    <div id="content" class="pt30 pb30">
        <div class="container">
            ...
            <form action="<?php echo DOCBASE.$sys_pages['booking-activities']['alias']; ?>" class="ajax-form" method="post">
                ...
                $result_activity = $db->query('SELECT * FROM pm_activity WHERE checked = 1 AND lang = '.LANG_ID.' ORDER BY rank');
                        ...
                        <div class="row booking-result activity-result">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-5 sep">
                                <div class="activity-data">
                                    ...
                                    <div class="hb-calendar" data-cur_month="<?php echo gmdate('n', $_SESSION['book']['from_date']); ?>" data-cur_year="<?php echo gmdate('Y', $_SESSION['book']['from_date']); ?>" data-custom_var="activity=<?php echo $id_activity; ?>" data-day_loader="<?php echo getFromTemplate('common/get_days_activity.php'); ?>"></div>
                                </div>
                            </div>
                        </div>
                        <hr>
